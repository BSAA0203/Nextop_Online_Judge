          ...
          <table width='70%' border=0 cellpadding=2 cellspacing=1 bgcolor=#777777>
            <tr>
              <td height=20 align=center bgcolor=#999999>
                <font color=white size=3><strong>글 쓰기</strong></font>
              </td>
            </tr>
          </table>
          <table width='70%'>
            <tr>
              ...
              <td align=left>
                <INPUT type=text name=title size=40 maxlength=35 required>
              </td>
            </tr>
            <tr>
              <td width=60 align=center><strong>내용</strong></td>
              <td align=left>
                <TEXTAREA name=content id=myNicEditor style='width:98%; height:700px;'></TEXTAREA>
              </td>
            </tr>
            <tr>
